...
Conferences 
------
1. Yujie Zhang, **Bin Gao✉** and Tulika Mitra, "[SAEM: Stage-Aware Expert Management for Memory-Efficient MoE Inference in Chain-of-Thought Reasoning](https://dac.com/2026/accepted-paper-ids)", in the The Chips to the Systems Conferences (DAC), Long Beach, US, 2026.
1. Dan Chen, Huize Li, Zhaoying Li, Huiying Lan, Xiang Liu, Zerui Li, Dan Wu, **Bin Gao✉** and Tulika Mitra, "[RAGNMP: Leveraging Elimination Tree to Accelerate RAG with Near-Memory Processing](https://dac.com/2026/accepted-paper-ids)", in the The Chips to the Systems Conferences (DAC), Long Beach, US, 2026.
1. Beichen Ning, Yina Lv, Tianyu Ren, **Bin Gao**, Xiangyu Yao, Jie Zhang, Qiao Li and Chun Jason Xue, "[WILL: Write Invalidation Skipping for QLC NAND by Leveraging Data Lifespan and Latency Awareness](https://dac.com/2026/accepted-paper-ids)", in the The Chips to the Systems Conferences (DAC), Long Beach, US, 2026.
1. Fujun He, Tuo Fang, Huaxiang Cai, Baolong Cui, Zhihe Zhang, Yishan Yao, Xiabing Li, Linyi Du, Chuyue Ye, Pingyi Huo, **Bin Gao**, Yiming Zhang, Pengfei Zheng and Yunfei Du, "[MemFlow: Characterizing Memory Traffic Contention in Disaggregated Architectures](https://dac.com/2026/accepted-paper-ids)", in the The Chips to the Systems Conferences (DAC), Long Beach, US, 2026.
1. Huize Li, Qinggang Wang, **Bin Gao**, Dan Chen, Yu Huang, Xin Xin, "[DANMP: Accelerating Multi-Scale Deformable Attention Using Near-Memory-Processing Architecture](https://dipsa-qub.github.io/ICS2026-webpage/))", in the ACM International Conference on Supercomputing (ICS), Belfast, Northern Ireland, United Kingdom, 2026.
